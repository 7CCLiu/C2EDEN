...
if rank == 0:
    ...
    # with open('./result/a9a.agd.grad.txt','w') as f:
    #     print(g_agd, file=f)
    # with open('./result/a9a.agd.func.txt','w') as f:
    #     print(f_agd, file=f)
    # with open('./result/a9a.agd.time.txt','w') as f:
    #     print(t_agd, file=f)
    # with open('./result/a9a.giant.grad.txt','w') as f:
    #     print(g_giant, file=f)
    # with open('./result/a9a.giant.func.txt','w') as f:
    #     print(f_giant, file=f)
    # with open('./result/a9a.giant.time.txt','w') as f:
    ...
    plt.tight_layout()
    plt.savefig('img/a9a.epoch_grad.sc16.png')
    plt.savefig('img/a9a.epoch_grad.sc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/a9a.epoch_func.sc16.png')
    plt.savefig('img/a9a.epoch_func.sc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/a9a.time_grad.sc16.png')
    plt.savefig('img/a9a.time_grad.sc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/a9a.time_func.sc16.png')
    plt.savefig('img/a9a.time_func.sc16.svg', format = 'svg', transparent=True)
