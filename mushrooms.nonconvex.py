...
# passing MPI datatypes mushroomslicitly
...
if rank == 0:
    ...
    # with open('./result/mushrooms.gd.grad.txt','w') as f:
    #     print(g_gd, file=f)
    # with open('./result/mushrooms.gd.func.txt','w') as f:
    #     print(f_gd, file=f)
    # with open('./result/mushrooms.gd.time.txt','w') as f:
    #     print(t_gd, file=f)
    # with open('./result/mushrooms.cubic.grad.txt','w') as f:
    #     print(g_cubic, file=f)
    # with open('./result/mushrooms.cubic.func.txt','w') as f:
    #     print(f_cubic, file=f)
    # with open('./result/mushrooms.cubic.time.txt','w') as f:
    #     print(t_cubic, file=f)
    # with open('./result/mushrooms.cedin.grad.txt','w') as f:
    #     print(g_cedin, file=f)
    # with open('./result/mushrooms.cedin.func.txt','w') as f:
    #     print(f_cedin, file=f)
    # with open('./result/mushrooms.cedin.time.txt','w') as f:
    ...
    plt.tight_layout()
    plt.savefig('img/mushrooms.epoch_grad.nc16.png')
    plt.savefig('img/mushrooms.epoch_grad.nc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/mushrooms.epoch_func.nc16.png')
    plt.savefig('img/mushrooms.epoch_func.nc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/mushrooms.time_grad.nc16.png')
    plt.savefig('img/mushrooms.time_grad.nc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/mushrooms.time_func.nc16.png')
    plt.savefig('img/mushrooms.time_func.nc16.svg', format = 'svg', transparent=True)
