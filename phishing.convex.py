...
if rank == 0:
    ...
    plt.tight_layout()
    plt.savefig('img/phishing.epoch_grad.sc16.png')
    plt.savefig('img/phishing.epoch_grad.sc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/phishing.epoch_func.sc16.png')
    plt.savefig('img/phishing.epoch_func.sc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/phishing.time_grad.sc16.png')
    plt.savefig('img/phishing.time_grad.sc16.svg', format = 'svg', transparent=True)
    ...
    plt.tick_params('y',labelsize=21)
    plt.tight_layout()
    plt.savefig('img/phishing.time_func.sc16.png')
    plt.savefig('img/phishing.time_func.sc16.svg', format = 'svg', transparent=True)
